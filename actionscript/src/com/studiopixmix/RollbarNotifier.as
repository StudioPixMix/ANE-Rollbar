package com.studiopixmix {
    ...
    import com.studiopixmix.JSONEncoder;
    import com.studiopixmix.StackTrace;
    import com.studiopixmix.StackTraceParser;
	...
	internal final class RollbarNotifier extends Sprite {
		...
		public function setPersonData(id:String, username:String, email:String):void {
			this.person = {id:id, username:username, email:email};
		}
